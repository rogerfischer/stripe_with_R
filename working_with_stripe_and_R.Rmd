...
- lost: last appearance of the customer with a failed payment. Lost doesn't mean he has cancelled.
- recurring: customers that are neither new nor lost

**Note**: Cancelled customers simply dispappear. Lost users can reappear as recurring when their payment goes through.
