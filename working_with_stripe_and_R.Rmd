...
- lost: last appearance of the customer with a failed payment. Lost doesn't mean she has cancelled.
- recurring: customers that are neither new nor lost

**Note**: Cancelled customers simply dispappear. 
Lost customers can reappear as recurring in the following week when their payment goes through.
